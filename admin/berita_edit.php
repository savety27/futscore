        ...
        <div class="menu">
            ...
            <?php 
                ...
                if ($item['submenu']) {
                    ...
                    // Untuk menu Berita, cek juga berita_edit.php dan berita_create.php
                    if ($current_page === $item['url'] || 
                        ($item['url'] === 'berita.php' && ($current_page === 'berita_edit.php' || $current_page === 'berita_create.php'))) {
                        $isActive = true;
                    }
                }
            ?>
