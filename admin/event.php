    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <?php if (isset($_SESSION['error_message'])): ?>
                <div class="alert alert-danger"><i class="fas fa-exclamation-circle"></i><span><?php echo htmlspecialchars($_SESSION['error_message']);
                                                                                                unset($_SESSION['error_message']); ?></span></div>
            <?php endif; ?>
            <?php if (isset($_SESSION['success_message'])): ?>
                <div class="alert alert-success"><i class="fas fa-check-circle"></i><span><?php echo htmlspecialchars($_SESSION['success_message']);
                                                                                            unset($_SESSION['success_message']); ?></span></div>
            <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="action-cell">
                                        <div class="action-buttons-inline">
                                            ...
                                            <a href="event_bracket.php" class="action-btn btn-bracket" title="Kelola Bracket"><i class="fas fa-diagram-project"></i></a>
                                            ...
                                            <button
                                                ...
                                                <?php endif; ?>><i class="fas fa-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
