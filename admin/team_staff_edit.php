...
<title>Edit Team Staff - FutScore</title>
            ...
            <?php 
                ...
                if ($item['submenu']) {
                    ...
                    foreach($item['items'] as $subKey => $subUrl) {
                        // Untuk halaman team_staff_edit.php, kita juga ingin submenu team_staff aktif
                        if($current_page === $subUrl || 
                           ($subKey === 'team_staff' && $current_page === 'team_staff_edit.php')) {
                            $isActive = true;
                            $isSubmenuOpen = true;
                            break;
                        }
                ...
                <div class="submenu <?php echo $isSubmenuOpen ? 'open' : ''; ?>" id="submenu-<?php echo $key; ?>">
                    ...
                    <div class="submenu-item">
                        <a href="<?php echo $subUrl; ?>" 
                           class="submenu-link <?php echo ($current_page === $subUrl || ($subKey === 'team_staff' && $current_page === 'team_staff_edit.php')) ? 'active' : ''; ?>">
