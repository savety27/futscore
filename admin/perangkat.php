...
<head>
    ...
    <style>
        ...
        * {
        ...
        .perangkat-search-group {
            position: relative
        }

        .perangkat-search-group i {
            position: absolute;
            left: 12px;
            top: 50%;
            transform: translateY(-50%);
        ...
        .perangkat-search-input:focus,
        .perangkat-filter-select:focus {
            outline: none;
            border-color: var(--primary);
            box-shadow: 0 0 0 3px rgba(10, 36, 99, .12)
        }

        .perangkat-filter-actions {
            display: flex;
            gap: 8px
        }
        ...
        .btn-filter:hover {
            ...
            box-shadow: 0 8px 18px rgba(10, 36, 99, .22)
        }
        ...
        .data-table tbody tr:hover {
            background: #eef5ff;
            transform: translateY(-3px);
            box-shadow: 0 12px 24px rgba(10, 36, 99, .2), 0 0 0 1px rgba(76, 138, 255, .35);
            z-index: 2
        }
        ...
        @media (max-width:768px) {
            ...
            .perangkat-filter-actions .btn-filter,
            .perangkat-filter-actions .clear-filter-btn {
                width: 100%;
                justify-content: center
            }
        }
...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <?php if (isset($_SESSION['success_message'])): ?><div class="alert alert-success"><?php echo htmlspecialchars($_SESSION['success_message']);
