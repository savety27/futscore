...
$menu_items = [
    ...
    'master' => ['icon' => '📊', 'name' => 'Master Data', 'submenu' => true, 'items' => ['player', 'team', 'team_staff', 'admin_users']],
...
<title>Tambah Pelatih - FutScore</title>
                ...
                <div class="submenu <?php echo $key === 'master' ? 'open' : ''; ?>" id="submenu-<?php echo $key; ?>">
                    ...
                    <div class="submenu-item">
                        ...
                        <a href="<?php echo $subitem_url; ?>" 
                           class="submenu-link <?php echo $subitem === 'admin_users' ? 'active' : ''; ?>">
                           <?php 
                           if ($subitem === 'admin_users') {
                               echo 'Pelatih';
                           } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.menu-link, .submenu-link').forEach(link => {
        if (link.getAttribute('href') === currentPage || 
            link.getAttribute('href') === 'admin_users.php') {
