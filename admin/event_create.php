...
<div class="wrapper">
            ...
            <?php
                ...
                if ($item['submenu']) {
                    foreach ($item['items'] as $subUrl) {
                        if ($current_page === $subUrl || $current_page === 'event_create.php') {
                            $isActive = true;
                            break;
                        }
                    }
                    ...
                    if ($key === 'event') {
                        $isActive = in_array($current_page, ['event.php', 'event_create.php'], true);
                    } else {
    ...
    <div class="main">
        <div class="topbar">
            <div class="greeting">
                <h1>Tambah Event</h1>
                <p>Form event dengan konsep seragam seperti form team</p>
            </div>
